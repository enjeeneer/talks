...
authors:
- Scott Jeen
subtitle: Choosing impactful research problems
...
## Baselines and oracles: is your problem really a problem?
  ...
  **Problem**                       **Baseline**       **Oracle**
  --------------------------------- ------------------ --------------------
  Solar PV conversion efficiency ☀️ 31.25% (Perovskite 33.7%
                                    Tandem Cells)      (Shockley-Queisser
                                                       Limit)

  Wind conversion efficiency 💨     \~30% (GE          59.3% (Betz Limit)
                                    Haliade-X)         

  Building intelligent machines 🤖  GPT-4              Humans

  Unifying the four fundamental     The Standard Model The Universe
  forces 🔎                                            
  -------------------------------------------------------------------------
